...
export const COTIZACIONES: Cotizacion[] = [
    ...
    lineas: [
      {
        id: "c7-apliques",
        espacio: "corredor",
        descripcion: "Apliques",
        cantidad: 2,
        valorUnitario: 48_000,
        manoObra: 0,
        materiales: 96_000,
        nota: "Son las luces para los cuadros del muro del corredor.",
      },
      { id: "c7-cable", espacio: "corredor", descripcion: "Cable", cantidad: 1, valorUnitario: 20_000, manoObra: 0, materiales: 20_000 },
      { id: "c7-apagador", espacio: "corredor", descripcion: "Apagador doble", cantidad: 1, valorUnitario: 12_000, manoObra: 0, materiales: 12_000 },
      { id: "c7-instalacion", espacio: "corredor", descripcion: "Servicio compra e instalación", cantidad: 1, manoObra: 150_000, materiales: 0 },
    ],
  },
  {
    numero: 8,
    servicio: "Panel WPC y repisas",
    fecha: "2026-09-18",
    ...
    lineas: [
      {
        ...
        manoObra: 0,
        materiales: 300_000,
        nota: "Son los entrepaños del corredor.",
      },
      {
        id: "c8-panel-wpc",
        espacio: "corredor",
        descripcion: "Panel WPC",
        cantidad: 6,
        valorUnitario: 40_000,
        manoObra: 0,
        materiales: 240_000,
        nota: "El WPC es panel imitación madera: se toma como la moldura de madera del muro junto al balcón.",
      },
      { id: "c8-pega", espacio: "corredor", descripcion: "Pega", cantidad: 1, valorUnitario: 31_000, manoObra: 0, materiales: 31_000 },
      { id: "c8-toma", espacio: "corredor", descripcion: "Toma + apagador", cantidad: 1, valorUnitario: 15_000, manoObra: 0, materiales: 15_000 },
      { id: "c8-cables", espacio: "corredor", descripcion: "Cables", cantidad: 1, valorUnitario: 15_000, manoObra: 0, materiales: 15_000 },
      { id: "c8-cintas", espacio: "corredor", descripcion: "Cintas LED", cantidad: 1, valorUnitario: 20_000, manoObra: 0, materiales: 20_000 },
      { id: "c8-transporte", espacio: "corredor", descripcion: "Transporte", cantidad: 1, valorUnitario: 60_000, manoObra: 0, materiales: 60_000 },
      { id: "c8-instalacion", espacio: "corredor", descripcion: "Servicio compra e instalación", cantidad: 1, manoObra: 350_000, materiales: 0 },
    ],
  },
  {
    numero: 9,
    servicio: "Paneles LED y otros",
    fecha: "2026-09-18",
    ...
    lineas: [
      {
        id: "c9-paneles",
        espacio: "general",
        descripcion: "Paneles LED",
        cantidad: 10,
        valorUnitario: 12_000,
        manoObra: 280_000,
        materiales: 120_000,
        nota: "La cotización no dice en qué espacios van los paneles.",
      },
      { id: "c9-tapas", espacio: "general", descripcion: "Tapas", cantidad: 4, valorUnitario: 10_000, manoObra: 25_000, materiales: 40_000 },
      { id: "c9-zumbador", espacio: "general", descripcion: "Zumbador", cantidad: 1, valorUnitario: 52_000, manoObra: 30_000, materiales: 52_000 },
      { id: "c9-pulsador", espacio: "general", descripcion: "Pulsador timbre", cantidad: 1, valorUnitario: 8_000, manoObra: 10_000, materiales: 8_000 },
      { id: "c9-toma-tv", espacio: "general", descripcion: "Toma TV alcoba", cantidad: 1, valorUnitario: 40_000, manoObra: 60_000, materiales: 40_000, nota: "La cotización no dice de cuál alcoba." },
    ],
  },
  {
    numero: 10,
    servicio: "Mortero piso cocina",
    fecha: "2026-09-18",
    archivo: "/cotizaciones/cotizacion-10.png",
    lineas: [
      {
        id: "c10-mortero",
        espacio: "cocina",
        descripcion: "Mortero + microcemento debajo lavaplatos",
        cantidad: 1,
        valorUnitario: 60_000,
        manoObra: 60_000,
        materiales: 60_000,
      },
      {
        id: "c10-sellado",
        espacio: "cocina",
        descripcion: "Sellado muro debajo lavadero",
        cantidad: 1,
        valorUnitario: 10_000,
        manoObra: 30_000,
        materiales: 10_000,
  ...
  },
  {
    ...
    fecha: "2026-09-19",
    archivo: "/cotizaciones/cotizacion-11.png",
    lineas: [
      {
        id: "c11-mano-obra",
        espacio: "cuarto-util",
        ...
        manoObra: 1_400_000,
        materiales: 0,
        nota: "Sólo mano de obra: los materiales van en la cotización 13. Los residuos salen al camión el martes, o la basura al lugar destinado en el edificio.",
      },
    ],
  ...
  },
  {
    ...
    fecha: "2026-09-22",
    archivo: "/cotizaciones/cotizacion-12.png",
    lineas: [
      {
        id: "c12-varios",
        espacio: "general",
  ...
  },
  {
    ...
    fecha: "2026-09-23",
    archivo: "/cotizaciones/cotizacion-13.png",
    lineas: [
      { id: "c13-acrilica", espacio: "cuarto-util", descripcion: "Acrílica blanca 1/4", manoObra: 0, materiales: 40_000 },
      { id: "c13-rodillo", espacio: "cuarto-util", descripcion: "Rodillo", manoObra: 0, materiales: 10_000 },
      { id: "c13-masilla", espacio: "cuarto-util", descripcion: "Masilla y cinta malla", manoObra: 0, materiales: 60_000 },
      { id: "c13-estribos", espacio: "cuarto-util", descripcion: "Estribos hierro", manoObra: 0, materiales: 20_000 },
      { id: "c13-lampara", espacio: "cuarto-util", descripcion: "Lámpara y encauchetado", manoObra: 0, materiales: 30_000 },
      { id: "c13-estuco", espacio: "cuarto-util", descripcion: "Estuco plástico", manoObra: 0, materiales: 24_500 },
      {
        id: "c13-toma",
        espacio: "cuarto-util",
      ...
      { id: "c13-tapa", espacio: "cuarto-util", descripcion: "Tapa lisa", manoObra: 0, materiales: 500 },
    ],
    nota: "Llegó por WhatsApp, sin fecha propia: se toma la del pago.",
  },
];
...
export const PAGOS: Pago[] = [
  ...
  {
    numero: 9,
    fecha: "2026-09-19T06:33",
    valor: 2_134_000,
    comprobante: "0000094500",
    destino: "Oscar Ferreteria",
    archivo: "/pagos/pago-9.jpeg",
    nota: "Cotizaciones 7 a 10: apliques, panel WPC y repisas, paneles LED y mortero de la cocina.",
  },
  {
    numero: 10,
...
export const CUENTAS: Cuenta[] = [
  ...
  {
    cotizaciones: [7, 8, 9, 10],
    pagos: [9],
    nota: "Las cuatro cotizaciones del 18 de septiembre se pagaron en una sola transferencia: 278.000 + 1.031.000 + 665.000 + 160.000 = 2.134.000.",
  },
  { cotizaciones: [11], pagos: [10] },
  { cotizaciones: [12], pagos: [11] },
  {
    cotizaciones: [13],
    pagos: [12],
    redondeo: 25_000,
